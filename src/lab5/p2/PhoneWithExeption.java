...
public class PhoneWithExeption {
    String first_name, last_name, middle_name;
    String address, credit_number;
    int debet, credit;
    int domestic, international;

    public PhoneWithExeption() {
    }

    public PhoneWithExeption(String first_name, String last_name, String middle_name, String address, String credit_number, int debet, int credit, int domestic, int international) {
    ...
    public static void main(String[] args) {
        ...
        int n = in.nextInt();
        PhoneWithExeption[] abonents = new PhoneWithExeption[n];
        for (int i = 0; i < n; i++) {
            System.out.print("Введите данные абонента: ");
            abonents[i]= new PhoneWithExeption(in.next(), in.next(), in.next(), in.next(), in.next(),
